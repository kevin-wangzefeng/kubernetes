...
func (t *TolerationMatch) PodToleratesNodeTaints(pod *api.Pod, nodeName string, nodeInfo *schedulercache.NodeInfo) (bool, error) {
	node, err := t.info.GetNodeInfo(nodeName)
	if err != nil {
		return false, err
	}
