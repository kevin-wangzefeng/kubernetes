...
func init() {
	admission.RegisterPlugin("LimitPodAntiAffinityTopology", func(client clientset.Interface, config io.Reader) (admission.Interface, error) {
...
// NewInterPodAntiAffinity creates a new instance of the LimitPodAntiAffinityTopology admission controller
